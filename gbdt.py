...
##from GBDT.tree_plot import plot_tree, plot_all_trees,plot_multi,plot_tree_model
from GBDT.tree_plot import plot_all_trees,plot_tree_model
...
class GradientBoostingRegressor(BaseGradientBoosting):
    ...
    def predict(self, data):
        ...
        print('predict_value is ', data['predict_value'])
        print('predict_value mse is ', mse(data['predict_value'], data['label']))
    ...
    def predicts(self, data):
        ...
        for iter in range(1, self.n_trees+1):
            ...
            # pdb.set_trace()
        data['predict_value'] = data[f_m_name]
        print('model mse is ', mse(data['predict_value'], data['label']))
        # pdb.set_trace()
'''
